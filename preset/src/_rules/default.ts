...
import { borders, uedBorders } from './border'
import { bgColors, colorScheme, opacity, background, color, colorToken, colorInteractionToken } from './color'
...
import { boxShadows, shadowToken } from './shadow'
...
export const rules: Rule<Theme>[] = [
  ...
  bgColors,
  colorScheme,
  background, color, colorToken, colorInteractionToken,
  svgUtilities,
  borders,
  uedBorders,
  contentVisibility,
